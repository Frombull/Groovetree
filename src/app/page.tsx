            ...
            <div className="space-y-6 lg:space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">
                    Monitor how many people visit your page and track your
                    growth over time
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">
                    See which trees your audience engages with most and optimize
                    your content
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-lg">
                    Get instant updates on your page performance and audience
                    engagement
                  </p>
                </div>
              </div>
